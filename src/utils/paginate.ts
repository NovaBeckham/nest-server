 ...
 * @Description:
 * @Author: hyx
 * @Date: 2024-10-17 17:37:47
 */

import { mergeDeepRight } from 'ramda'
import { Document, FilterQuery, Model, QueryOptions, Schema } from 'mongoose'
...
export function paginate<T>(this: Model<T>, filterQuery: PaginateQuery<T> = {}, options: PaginateOptions = {}) {
  const { page, perPage, dateSort, projection, $queryOptions, ...resetOptions } = mergeDeepRight(
    { ...DEFAULT_OPTIONS },
    { ...options }
  )
